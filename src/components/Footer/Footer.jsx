...
const Footer = () => {
  ...
  return (
    <footer className="bottom-0 fixed bg-white py-5 w-full flex border-t border-gray-200 justify-center space-x-12 text-gray-400 mt-auto">
          <div onClick={han} className={(path === "/home" ? 'text-emerald-500 flex justify-center items-center flex-col' : 'flex justify-center items-center flex-col cursor-pointer' )}>
